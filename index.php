...
<table width="100%" height="372" border="0" cellspacing="20" id="tablacontenido">
  <tr>
   ...
   <tr class="nombreyperfil">
        <td height="20" colspan="2"><a href="#" style="color:#333; text-decoration: none; font-size: 16px;">Gilmer Franko</a></td>
        <td width="80" style="background-color:#E3E3E3"><a href="#" class="icon-face butom" style="font-size:24px"></a></td>
      <tr>
        <td colspan="3" class="imagenitem"><em><img src="/src/img/facebook.jpg" width="217" height="130" alt="Chimo" /></em></td>
      </tr>
      <tr>
      ...
      <tr class="tablaitem">
        ...
        <td width="33%" class="butom"><a href="#">Puntuar</a></td>
      </tr>
      <tr class="tablaitem">
  ...
  <tr>
    <td><table width="91%" border="0" cellpadding="0" cellspacing="0" class="tablaitem">
      ...
      <tr class="tablaitem">
        ...
        <td width="33%" class="butom"><a href="#">Ver</a></td>
      </tr>
      <tr class="tablaitem">
